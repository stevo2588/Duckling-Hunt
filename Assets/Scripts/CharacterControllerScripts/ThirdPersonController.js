...
var walkSpeed = 16.0; // The speed when walking
var trotSpeed = 18.0; // after trotAfterSeconds of walking we trot with trotSpeed
var runSpeed = 26.0; // when pressing "Fire3" button (cmd) we start running
